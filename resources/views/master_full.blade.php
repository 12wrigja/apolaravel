...
@section('nav_menu_items')
    ...
    <li class="dropdown">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Chapter
            Events<span
                    class="caret"></span></a>
        <ul class="dropdown-menu" role="menu">
            <li><a class="item" href="{{route('m4m')}}">March for Marfan</a></li>
            <li><a class="item" href="{{route('calendar')}}">View Event Calendar</a></li>
        </ul>
    </li>
    {{--TODO Fix up the joining APO section--}}
    {{--<li class="dropdown">--}}
