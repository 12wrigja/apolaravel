...
@section('crud_form')
    <manage_exec_meetings_form inline-template>
        <h1>Manage Exec Meetings</h1>

        <p>Below is the exec meeting management tool. This can be used to modify the stored minutes or present
            chapter members at a exec meeting. Meetings marked with a red symbol are potential duplicates of
            ...
            <div class="panel panel-default">
                ...
                <div id="collapse@{{report.id}}" class="panel-collapse collapse" role="tabpanel"
                    ...
                    <div class="panel-body">
                        @include('reports.execmeetings.report_details')
                ...
                <div class="modal-dialog modal-wide">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Edit Exec Meeting</h4>
                        </div>
                        <div class="modal-body">
                            {!! Form::open(['route'=>['report_update','type'=>'exec_meetings','id'=>':id'],'class'=>'collapse in','v-el'=>'iform'])!!}
