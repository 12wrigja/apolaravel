...
class OldServiceReportsSeeder extends Seeder
{
    public function run()
    {
        ...
        $oldServiceReports = DB::connection('apo')->table('tblsvcrpt')->select('id','date as event_date','event as display_name','location','isOutside','offcampus as off_campus','traveltime as travel_time','comments as description','approved','serviceType as service_type','submittedBy as creator_id')->get();
...
//                $brother['minutes'] = $oldBrother->hours%12;
