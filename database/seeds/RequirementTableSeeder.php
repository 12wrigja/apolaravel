...
class RequirementTableSeeder extends Seeder
{
    public function run()
    {
        ...
        $activetotalhours = Requirement::createFromValues("Active Member Total Hours", "As an active member in APO TY, you are required to complete at least 20 hours of service each semester.", 20, 'GEQ', function($reports,$reportValues){
            $val = 0;
            foreach($reports as $report){
                $val += $reportValues[$report->id];
            }
        ...
        $activeinsidehours = Requirement::createFromValues("Active Member Inside Hours", "As an active member in APO TY, at least 10 of the 20 hours of service each semester need to be inside service hours.", 10, 'GEQ', function($reports,$reportValues){
            $val = 0;
            foreach($reports as $report){
                $val += $reportValues[$report->id];
            }
        ...
        $activebrotherhoodhours = Requirement::createFromValues("Active Member Brotherhood Hours", "As an active member in APO TY, you are required to attend at least 2 hours of brotherhood events each semester.", 2, 'GEQ', function($reports,$reportValues){
            $val = 0;
            foreach($reports as $report){
                $val += $reportValues[$report->id];
            }
        ...
        $activechaptermeetings = Requirement::createFromValues("Active Member Chapter Meetings", "As an active member in APO TY, you are required to attend at least 8 chapter meetings each semester.", 8, 'GEQ', function($reports,$reportValues){
            $val = 0;
            foreach($reports as $report){
                $val += $reportValues[$report->id];
            }
        ...
        $activepledgemeetings = Requirement::createFromValues("Active Member Pledge Meetings", "As an active member in APO TY, you are required to attend at least 1 pledge meeting each semester", 1, 'GEQ', function($reports,$reportValues){
            $val = 0;
            foreach($reports as $report){
                $val += $reportValues[$report->id];
            }
        ...
        $associatetotalhours = Requirement::createFromValues("Associate Member Total Hours", "As an associate member in APO TY, you are required to complete at least 10 hours of service each semester", 10, 'GEQ', function($reports,$reportValues){
            $val = 0;
            foreach($reports as $report){
                $val += $reportValues[$report->id];
            }
        ...
        $associateinsidehours = Requirement::createFromValues("Associate Member Inside Hours", "As an associate member in APO TY, at least 10 of the hours you complete each semester must be inside hours.", 10, 'GEQ', function($reports,$reportValues){
            $val = 0;
            foreach($reports as $report){
                $val += $reportValues[$report->id];
            }
        ...
        $associatebrotherhoodhours = Requirement::createFromValues("Associate Member Brotherhood Hours", "As an associate member in APO TY, you are required to attend at least 2 hours of brotherhood events each semester.", 2, 'GEQ', function($reports,$reportValues){
            $val = 0;
            foreach($reports as $report){
                $val += $reportValues[$report->id];
            }
        ...
        $pledgetotalhours = Requirement::createFromValues("Pledge Member Total Hours", "As an pledge of APO TY, you are required to complete at least 10 hours of service this semester.", 10, 'GEQ', function($reports,$reportValues){
            $val = 0;
            foreach($reports as $report){
                $val += $reportValues[$report->id];
            }
        ...
        $pledgeinsidehours = Requirement::createFromValues("Pledge Member Inside Hours", "As an pledge of APO TY, at least 8 of the 10 hours of service this semester need to be inside service hours.", 8, 'GEQ', function($reports,$reportValues){
            $val = 0;
            foreach($reports as $report){
                $val += $reportValues[$report->id];
            }
        ...
        $pledgebrotherhoodhours = Requirement::createFromValues("Pledge Member Brotherhood Hours", "As an pledge of APO TY, you are required to attend at least 2 hours of brotherhood events each semester.", 2, 'GEQ', function($reports,$reportValues){
            $val = 0;
            foreach($reports as $report){
                $val += $reportValues[$report->id];
            }
