...
use APOSite\Http\Transformers\DuesReportTransformer;
...
class DuesReport extends BaseModel
{
    ...
    public function transformer(Manager $manager)
    {
        ...
        return new DuesReportTransformer($manager);
    }

    public static function create(array $attributes = [])
    {
        $attributes['report_date'] = Carbon::now();
    ...
    {
        if (array_key_exists('type', $brotherData) && $brotherData['type'] == 'full') {
