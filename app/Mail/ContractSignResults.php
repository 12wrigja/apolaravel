...
class ContractSignResults extends Mailable
{
    ...
    {
        return $this->view('emails.contract.contract_sign_results')->with([
            'userId' => $this->userId,
            ...
            'reason' => $this->reason,
        ])->subject('Contract Signed for ' . $this->userFullName . ' (' . $this->userId . ') ' . $this->semesterText);
    }
}
